...
<html lang="en">
    ...
    <body>
        <main class="container-fluid dContainer">
            <div class="row border border-dark min-vh-100">
                <div class="col-lg-2 pt-2 position-relative">
                    <div class='leftBar'>
                        <nav class="nav flex-column nav-pills pt-5">
                          <a class="nav-link active" href="enquiry">ENQUIRY</a>
                          <a class="nav-link" href="consultation">CONSULTATION</a>
                           <a class="nav-link" href="landingPageConsultation">DIGITAL MARKETING CONSULTATION</a>
                ...
                <div class="col-lg-10">
                    <div class='mt-5 pr-lg-3'>
                        <div class='bg-white p-4 py-3 mb-4' style='margin-right: 30px;'>
                            <h4 class='m-0'>Enquiry Data</h4>
                        </div>
                            <div class="py-3 mb-4">  
                                 <button name="create_excel" id="create_excel" class="btn btn-success">Download Excel File</button>  
                            </div>
                        <div class='bg-white p-4 shadow' style='margin-right: 30px;'>
